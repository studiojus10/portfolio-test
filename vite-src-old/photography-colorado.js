...
(function () {
  ...
  var galleryPages = {
    'twelve-views': {
      page: 'photography-colorado-twelve-views.html',
      images: (function () {
        var a = [];
        for (var i = 1; i <= 12; i++)
          a.push(
    ...
    'rock-ledge': {
      page: 'photography-colorado-rock-ledge.html',
      images: (function () {
        var a = [];
        for (var i = 1; i <= 11; i++)
          a.push(
    ...
    golf: {
      page: 'photography-colorado-golf.html',
      images: (function () {
        var a = [];
        for (var i = 1; i <= 11; i++)
          a.push(
    ...
    cornfield: {
      page: 'photography-colorado-cornfield.html',
      images: (function () {
        var a = [];
        for (var i = 1; i <= 8; i++)
          a.push(
