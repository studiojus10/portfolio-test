...
(function () {
  ...
  var galleryPages = {
    sanctuary: {
      page: 'photography-nature-sanctuary.html',
      images: (function () {
        var a = [];
        for (var i = 1; i <= 10; i++)
          a.push(
            '/assets/images/Nature/Butterflies/Sanctuary/BUTTERFLIES-' +
    ...
    museum: {
      page: 'photography-nature-museum.html',
      images: [
        '/assets/images/Nature/Butterflies/Museum/BUTTERFLIES-11.jpg',
        '/assets/images/Nature/Butterflies/Museum/BUTTERFLIES-12.jpg',
        '/assets/images/Nature/Butterflies/Museum/BUTTERFLIES-13.jpg',
        '/assets/images/Nature/Butterflies/Museum/BUTTERFLIES-14.jpg',
        '/assets/images/Nature/Butterflies/Museum/BUTTERFLIES-15.jpg',
        '/assets/images/Nature/Butterflies/Museum/BUTTERFLIES-16.jpg',
        '/assets/images/Nature/Butterflies/Museum/BUTTERFLIES-17.jpg',
        '/assets/images/Nature/Butterflies/Museum/BUTTERFLIES-18.jpg',
      ],
    },
    flowers: {
      page: 'photography-nature-flowers.html',
      images: (function () {
        var a = [];
        for (var i = 1; i <= 12; i++)
          a.push(
            '/assets/images/Nature/Flowers/FLOWERS-' +
              String(i).padStart(2, '0') +
              '.jpg',
          );
        return a;
    ...
    landscapes: {
      page: 'photography-nature-landscapes.html',
      images: [
